...
function setDataWeb226ACCallBack(data){
	...
	if (result.flag=='Y'){
		...
		}else comLib.messageOut("4007",$("#WEB_201_TMPLT_SAVE").text(),'');//alert("등록에 실패하였습니다.");
		return;
	}else comLib.messageOut(msgLib.MSG_100,'');//alert("등록되었습니다.");
}
//var cur_year = '';
//var cur_month = '';
	...
	displayCalendarDay : function(){
		...
		if (st.week>0){
			...
			for (var i=st.week;i>0;i--){
				...
				//html.push("<div class='selected'><span class='today'>5</span><span class="ym-data">2017.01 (일)</span></div>
		...
		for (var i=1;i<=ed.date;i++){
			...
			html.push("<div class='r-cover'><span class='data'><span id='WEB_201_C_DDS'>소요시간</span> : <span id='dds'></span></span><span class='data mg-l10' id='span_delay'><font color='red'><span id='WEB_201_C_DELAY'>Delay Hours</span> : <span id='delay'></span></font></span><!--<a href='#none' class='btn-ms-type btn-min3' id='WEB_201_C_IMP_BL'>수입 B/L 조회</a>--></div>");
			html.push("<table class='ui-tb-box2'>");
			html.push("<caption>수입에 대한 출발지명, 출발시간, 도착지명, 도착시간,  EDI 신고마감, 장치장코드, 터미널, MRN No, Call Sign 표입니다.</caption>");
			html.push("<colgroup>");
			...
			html.push("<tbody>");
			html.push("<tr>");
			html.push("<th scope='col' id='WEB_201_C_POL'>출발지명</th>");
			html.push("<th scope='col' id='WEB_201_C_POL_ETD_TM'>출발시간</th>");
			html.push("<th scope='col' id='WEB_201_C_POD'>도착지명</th>");
			html.push("<th scope='col' id='WEB_201_C_POD_ETA_TM'>도착시간</th>");
			html.push("<th scope='col' id='WEB_201_C_MF_EDI_CLS_DTM'>EDI 신고 마감</th>");
			html.push("<th scope='col' id='WEB_201_C_NBRD_CD'>장치장 코드</th>");
			html.push("</tr>");
			html.push("<tr>");
			...
			html.push("</tr>");
			html.push("<tr>");
			html.push("<th scope='col' colspan='2' id='WEB_201_C_POL_TMN'>터미넗</th>");
			html.push("<th scope='col' colspan='2' id='WEB_201_C_POD_TMN'>터미널</th>");
			...
			html.push("<div class='r-cover'><span class='data'><span id='WEB_201_B_DDS'>소요시간</span> : <span id='dds'></span></span><span class='data mg-l10' id='span_delay'><font color='red'><span id='WEB_201_B_DELAY'>소요시간</span> : <span id='delay'></span></font></span><a href='#none' class='btn-ms-type btn-min' id='WEB_201_B_SCH_NOTICE'>NOTICE</a><a href='#none' class='btn-ms-type btn-min' id='WEB_201_B_NEW_BKG'>New Booking</a></div>");
			html.push("<table class='ui-tb-box2'>");
			html.push("<caption>수출에 대한 출발지명, 출발시간, 도착지명, 도착시간,  서류/VGM/EDI, 컨테이너 반입, CFS반입, 터미널, MRN No, CALL SIGN, 장치장코드 표입니다.</caption>");
			html.push("<colgroup>");
...
//			html.push("<col style='width:14.285%' />");
			...
			html.push("<tbody>");
			html.push("<tr>");
			html.push("<th scope='col' id='WEB_201_B_POL'>출발지명</th>");
			html.push("<th scope='col' id='WEB_201_B_POL_ETD_TM'>출발시간</th>");
			html.push("<th scope='col' id='WEB_201_B_POD'>도착지명</th>");
			html.push("<th scope='col' id='WEB_201_B_POD_ETA_TM'>도착시간</th>");
			html.push("<th scope='col' id='WEB_201_B_DOC_CLS_DTM'>서류/VGM/EDI</th>");
			html.push("<th scope='col' id='WEB_201_B_CGO_CLS_DTM'>컨테이너 반입</th>");
			html.push("<th scope='col' id='WEB_201_B_CFS_EDI_CLS_DTM'>CFS 반입</th>");
			html.push("<th scope='col' id='WEB_201_B_CTR_CD'>CTR_CD</th>");
			html.push("</tr>");
			html.push("<tr>");
			html.push("<td id='pol'></td>");//추후 국가 추가
			...
			html.push("<tbody>");
			html.push("<tr>");
			html.push("<th scope='col' colspan='2' id='WEB_201_B_POL_TMN'>터미넗</th>");
			html.push("<th scope='col' colspan='2' id='WEB_201_B_POD_TMN'>터미널</th>");
			html.push("<th scope='col' id='WEB_201_B_MRN'>MRN No.</th>");
			html.push("<th scope='col' id='WEB_201_B_CALL_SIGN_NO'>Call Sign</th>");
			html.push("<th scope='col' id='WEB_201_B_POL_EDI_CD'>장치장코드</th>");
			html.push("</tr>");
			html.push("<tr>");
			html.push("<td colspan='2' class='tl' id='pol_tmn'></td>");
			html.push("<td colspan='2' class='tl' id='pod_tmn'></td>");
		...
		if (ed.week<6){
			...
			html.push("<p class='tt fL'><span id='WEB_201_C_VSL'></span> : <span id='vsl_nm'></span></p>");
			html.push("<p class='tt fL mg-l10 hidden' id='REM4'><font color='red'><span id='WEB_201_C_REM1'></span></font></p>");
			html.push("<div class='r-cover'><span class='data'><span id='WEB_201_C_DDS'>소요시간</span> : <span id='dds'></span></span><span class='data mg-l10' id='span_delay'><font color='red'><span id='WEB_201_C_DELAY'>소요시간</span> : <span id='delay'></span></font></span><!--<a href='#none' class='btn-ms-type btn-min3' id='WEB_201_C_IMP_BL'>수입 B/L 조회</a>--></div>");
			html.push("<table class='ui-tb-box2'>");
			html.push("<caption>수입에 대한 출발지명, 출발시간, 도착지명, 도착시간,  EDI 신고마감, 장치장코드, 터미널, MRN No, Call Sign 표입니다.</caption>");
			html.push("<colgroup>");
			html.push("<col style='width:16.666%' />");
	...
	$.ajax({
        ...
        success : function(data){
			...
			listDiv.find('#WEB_201_B_SCH_NOTICE').click(function(){
				// 2018.01.31 최병선 주임 요청. 스케줄 조회 시, 스케줄 노티스 바로 띄울 수 있도록
				var varParam = {};
